  ...
  database.ref('users/' + userId + '/tasks').on('value', snapshot => {
    ...
    if (tasks) {
      Object.keys(tasks).forEach(key => {
        ...
        participant1.src = 'https://images.unsplash.com/photo-1600486913747-55e5470d6f40?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&amp;ixlib=rb-1.2.1&amp;auto=format&amp;fit=crop&amp;w=2550&amp;q=80';
        participant1.alt = 'participant';

        const participant2 = document.createElement('img');
        participant2.src = 'https://images.unsplash.com/photo-1583195764036-6dc248ac07d9?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&amp;ixlib=rb-1.2.1&amp;auto=format&amp;fit=crop&amp;w=2555&amp;q=80';
        ...
        const addParticipantIcon = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
        addParticipantIcon.setAttribute('xmlns', 'http://www.w3.org/2000/svg');
        ...
        const addParticipantPath1 = document.createElementNS('http://www.w3.org/2000/svg', 'path');
        addParticipantPath1.setAttribute('d', 'M12 5v14');
        const addParticipantPath2 = document.createElementNS('http://www.w3.org/2000/svg', 'path');
